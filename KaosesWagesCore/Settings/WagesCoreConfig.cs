...
namespace KaosesWagesCore.Settings
{
    ...
    public class WagesCoreConfig //: AttributeGlobalSettings<WagesCoreConfig>
    {

        private static WagesCoreConfig _instance = null;

        private WagesCoreConfig() { }

        public static WagesCoreConfig Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new WagesCoreConfig();
                return _instance;
            }
        }
